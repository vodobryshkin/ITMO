...
mkdir home
    mkdir home/s465774
        mkdir home/s465774/lab0

chmod 777 home/s465774
cd home/s465774/lab0
...
echo "3. Вывод содержимого файла wailord4 с номерами строк, оставить только строки, заканчивающиеся на 'e':"
cat wailord4 | grep -i '.*e$' | cat -n
...
ls -tr lab0/*a | tail -n 4

echo "5. Подсчёт количества символов содержимого файла rufflet7, запись результата в тот-же файл:"
wc -m rufflet7 >> rufflet7

echo "6. Рекурсивный вывод содержимого файлов из директории lab0, имя которых заканчивается на '7':"
cat $(ls -dp1 ./*/* | grep -E "$7") | sort 
